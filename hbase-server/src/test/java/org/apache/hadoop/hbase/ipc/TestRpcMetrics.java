...
public class TestRpcMetrics {
  ...
  public void testWrapperSource() {
    ...
    HELPER.assertGauge(MetricsHBaseServerSourceImpl.RESPONSE_QUEUE_SIZE_NAME, 107, serverSource);
    HELPER.assertGauge(MetricsHBaseServerSource.RESPONSE_QUEUE_NAME, 108, serverSource);
  }
