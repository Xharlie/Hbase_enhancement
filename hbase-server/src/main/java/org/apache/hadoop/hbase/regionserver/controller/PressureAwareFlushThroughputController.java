 ...
 * {@value #HBASE_HSTORE_FLUSH_MAX_THROUGHPUT_HIGHER_BOUND}, using the formula &quot;lower +
 * (higer - lower) * flushPressure&quot;, where flushPressure is in range [0.0, 1.0)</li>
 * </ul>
...
public class PressureAwareFlushThroughputController extends PressureAwareThroughputController {
  ...
  public static final String HBASE_HSTORE_FLUSH_MAX_THROUGHPUT_HIGHER_BOUND =
      "hbase.hstore.flush.throughput.higher.bound";

  private static final long DEFAULT_HBASE_HSTORE_FLUSH_MAX_THROUGHPUT_HIGHER_BOUND =
      200L * 1024 * 1024;
  ...
  public void setConf(Configuration conf) {
    ...
    this.maxThroughputHigherBound =
        conf.getLong(HBASE_HSTORE_FLUSH_MAX_THROUGHPUT_HIGHER_BOUND,
          DEFAULT_HBASE_HSTORE_FLUSH_MAX_THROUGHPUT_HIGHER_BOUND);
    ...
    LOG.info("Flush throughput configurations, higher bound: "
