...
public class HFileBlock implements Cacheable {
  ...
  HFileBlock(BlockType blockType, int onDiskSizeWithoutHeader, int uncompressedSizeWithoutHeader,
    ...
    init(blockType, onDiskSizeWithoutHeader, uncompressedSizeWithoutHeader, prevBlockOffset,
      offset, onDiskDataSizeWithHeader, nextBlockOnDiskSize, fileContext);
    ...
    private void finishBlock() throws IOException {
      ...
      if (onDiskBlockBytesWithHeader != uncompressedBlockBytesWithHeader) {
        putHeader(uncompressedBlockBytesWithHeader, 0,
          onDiskBlockBytesWithHeader.length + numBytes, uncompressedBlockBytesWithHeader.length,
          onDiskBlockBytesWithHeader.length);
      }
  ...
  static class FSReaderImpl implements FSReader {
    ...
    throws IOException {
      ...
      if (blk == null) {
        ...
        HFile.CHECKSUM_FAILURES.incrementAndGet(); // update metrics
