...
Name:t-search-adp-hbase-client-1_0_9_1-aquila
Version:1.0.9.1
...
rm -f ./%{HBASE_DIR_NAME}/bin/graceful*.sh
rm -f ./%{HBASE_DIR_NAME}/bin/rolling*.sh
rm -f ./%{HBASE_DIR_NAME}/bin/hbase-daemons.sh
rm -f ./%{HBASE_DIR_NAME}/bin/start-hbase.sh
rm -f ./%{HBASE_DIR_NAME}/bin/stop-hbase.sh
